        ...
        <>
            ...
            <main className="page-content animate-fade-in" style={{ maxWidth: '1000px', width: '90%' }}>
                <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
                    ...
                    <div style={{ maxWidth: '500px', margin: '2.5rem auto 0', position: 'relative' }}>
                        <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                            <Search
                                size={20}
                                style={{ position: 'absolute', left: '1.25rem', color: 'var(--accent-primary)', opacity: 0.7 }}
                            />
                            <input
                                type="text"
                                ...
                                onFocus={(e) => {
                                    ...
                                    e.currentTarget.style.boxShadow = '0 10px 30px -10px rgba(245, 158, 11, 0.2)';
                ...
                <div style={{
                    display: filteredBlogs.length > 0 ? 'grid' : 'block',
                    ...
                    {filteredBlogs.length > 0 ? (
                        ...
                        <div className="glass-panel" style={{ textAlign: 'center', padding: '5rem 2rem' }}>
                            ...
                            <h3 style={{ fontSize: '1.5rem', color: 'var(--text-primary)', marginBottom: '0.5rem' }}>No articles found</h3>
                            <p style={{ color: 'var(--text-secondary)' }}>We couldn't find any articles matching "{searchQuery}". Try a different keyword.</p>
                            <button
                                onClick={() => setSearchParams({})}
